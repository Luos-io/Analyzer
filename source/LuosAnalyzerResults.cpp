...
std::string DataTranslation(U64 frame_data1, U64 frame_data2, DisplayBase display_base)
{
    ...
    switch (frame_data1)
    { //choose how many bits will represent its value
        case 'PROT':
        {
            bit_num = 4;
            break;
    ...
    if (frame_data1 == 'SIZE')
    {
        AnalyzerHelpers::GetNumberString(frame_data2, Decimal, bit_num, number_str2, 128);
    }
    else
    {
        AnalyzerHelpers::GetNumberString(frame_data2, display_base, bit_num, number_str2, 128);
    }
    ...
    else if (frame_data1 == 'CMD')
    {
        switch (frame_data2)
        {
            ...
            case 11:
            {
                ss << "CMD = " << number_str2 << " BOOTLOADER_CMD";
                break;
            }
            case 12:
            {
                ss << "CMD = " << number_str2 << " BOOTLOADER_RESP";
                break;
            }
            case 13:
            {
                ss << "CMD = " << number_str2 << " GET_CMD";
                break;
            }
            case 14:
            {
                ss << "CMD = " << number_str2 << " SET_CMD";
                break;
            }
            case 15:
            {
            ...
            case 56:
            {
                ss << "CMD = " << number_str2 << " TEMPERATURE_LIMIT";
                break;
            }
            case 57:
            {
            ...
            case 58:
            {
                ss << "CMD = " << number_str2 << " ERROR_CMD";
                break;
            }
            default:
            {
                ss << "CMD = " << number_str2 << " UNKNOWN_CMD";
                break;
            }
        }
    }
